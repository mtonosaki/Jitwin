import { GuiDummyException, GuiUndefinedException } from 'mvfp/GuiExeption'
...
export type MvfpRenderResult = {
  ...
  sendEvents: (eventsArray: GuiEvents[][]) => void
}
...
function sendEvents(eventsArray: GuiEvents[][]): void {
